...
ROLE_SCOPE_POLICIES: dict[str, RoleScopePolicy] = {
    ...
    AgentRole.EVIDENCE_AUDITOR.value: RoleScopePolicy(
        ...
        allowed_claim_keys=["claim_support", "contradiction", "unsupported_claim", "citation_validation"],
    ...
    AgentRole.RISK_EXPERT.value: RoleScopePolicy(
        ...
        allowed_claim_keys=["risk", "human_escalation_required", "contradiction_risk", "schedule_risk"],
